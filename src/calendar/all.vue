<template>
    <div class="main-body-center module-wrapper">
        <Add v-show="isShow" :json="this.type" :name="$route.name" @myEvent="getChildData" :op1="op"></Add>
        <XQ v-show="isShowXQ" :xinxi="info" @myEventXQ="getChildDataXQ"></XQ>
                ...
                <div class="fc-unthemed">
                    ...
                    <div class="schedule">
                        <div class="box" v-for="v in schedule">
                            <table>
                                <tr v-for="c in v">
                                    <td v-for="i in c" :style="{width: 1000/7*i.colspan+'px',background: i.cur,opacity:i.op}" :colspan="i.colspan" :class="{add:i.title}" @click="look(i)">{{i.title}}
                                    </td>
                                </tr>
                            </table>
                        </div>
